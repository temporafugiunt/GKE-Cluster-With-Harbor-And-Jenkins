...
4) istio-ingressgateway acts as the external load balancer and also interacts with Let's Encrypt to setup the proper certificates for your websites in an automated way. This means at least two things:
